...
function drawPigeon() {
  ...
  fill(150);
  ellipse(0, 0, 85, 45);          // 원래 (170, 255) -> 대략 (0, 0) 기준으로 정렬
  ellipse(-20, 15, 85, 20);       // 원래 (150, 265) -> (-20, 15)
  ellipse(-10, 0, 85, 20);        // 원래 (160, 250) -> (-10, 0)
  ellipse(0, -10, 85, 20);        // 원래 (170, 240) -> (0, -10)
  pop(); 
  // ----------------------------------------
}
